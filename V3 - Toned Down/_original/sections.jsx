  ...
  return (
    <header className="lp-header">
      <div className="container lp-header-inner">
        <a href="#" className="lp-brand" aria-label="MBA USP/Esalq — início">
        ...
        <div className="lp-header-cta">
          <CyButton variant="ghost" size="md" as="a" href="#cta">Falar com o time</CyButton>
          <CyButton variant="primary" size="md" as="a" href="#cta"
          icon={<Icon name="ArrowRight" size={16} />}>Inscrever-se</CyButton>
        </div>
      </div>
    </header>);
...
function Hero({ gridIntensity = 'normal' }) {
  return (
    <section className="lp-section hero" id="hero">
      {/* camadas de fundo: imagem → overlay → grid interativo */}
        ...
        <div className="hero-content">
          <RevealOnScroll>
            <div className="hero-badges">
              ...
              <CyBadge tone="accent">Cyber Security</CyBadge>
              <CyBadge tone="mute">Aulas ao vivo</CyBadge>
            </div>
          </RevealOnScroll>
      ...
      <div className="hero-hud-tl hud" aria-hidden="true">
        <BinaryStrip length={16} seed="hero-tl" />
      </div>
      <div className="hero-hud-br hud" aria-hidden="true">
        <SerialTag prefix="[REV]" />
      </div>
    </section>);
    ...
    <section className="lp-section section-deep alt" id="mercado">
      <div className="container">
        <SectionHeader
          ...
          right={<Coordinates lat="23.5505° S" lng="46.6333° W" />} />
        ...
        <div className="mercado-grid">
          ...
          <RevealOnScroll key={it.label} delay={i * 60}>
              <CyCard tone="deep" className="mercado-card card-walk-light">
                <div className="mercado-card-head">
                  <span className="mercado-icon">
                    <Icon name={it.icon} size={24} color="var(--color-primary)" />
                  </span>
...
function Diferenciais() {
  ...
  return (
    <section className="lp-section section-deep" id="diferenciais">
      <div className="container">
        <SectionHeader
          tone="deep"
          ...
          right={<SerialTag system="USP" version="2026" />} />
        ...
        <div className="grid-3 diferenciais-grid">
          ...
          <RevealOnScroll key={it.title} delay={i * 60}>
              <CyCard tone="deep" className="diferencial-card card-walk-light">
      ...
      <div className="container">
          ...
          <RevealOnScroll key={p.name + i} delay={i % 4 * 60}>
              <article className="docente-card">
                <div className="docente-photo" aria-hidden="true">
                  ...
                  <span className="docente-photo-id hud">PRF-{String(i + 1).padStart(4, '0')}</span>
                </div>
        ...
        <RevealOnScroll delay={120}>
          <div className="docentes-foot">
            <BinaryStrip length={32} seed="docentes" />
        ...
        <div className="grid-3">
          ...
          <RevealOnScroll key={p.title} delay={i * 80}>
              <CyCard tone="light" className="persona-card">
                ...
                <span className="persona-tag hud">{p.tag}</span>
    ...
    <section className="lp-section section-deep alt" id="investimento">
      <div className="container">
        <SectionHeader
          ...
          right={<SerialTag system="PLAN" version="2026.1" />} />
    ...
    <section className="lp-section section-light" id="faq">
      <div className="container faq-container">
        <SectionHeader
          ...
          right={<BinaryStrip length={24} seed="faq" />} />
...
function CTA() {
  return (
    <section className="lp-section section-deep" id="cta">
      <div className="container cta-container">
        ...
        <RevealOnScroll delay={400}>
          <div className="cta-hud-row">
            <SerialTag prefix="[ENROLL]" system="USP" version="2026.1" />
            <Coordinates label="HQ" lat="22.7106° S" lng="47.6300° W" />
            <Timestamp />
          </div>
        </RevealOnScroll>
      </div>
