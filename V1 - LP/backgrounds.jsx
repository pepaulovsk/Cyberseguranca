...
function InteractiveGrid({
  ...
  const gridBorder = `rgba(0, 203, 201, ${intensity === 'subtle' ? 0.04 : 0.07})`;
        ...
        cellsArr.push(
          <div
            ...
            style={{
              ...
              width: cellSize,
              height: cellSize,
              background: a > 0.001 ? `rgba(0, 203, 201, ${a.toFixed(3)})` : 'transparent',
...
/* ── DotPattern ──────────────────────────────────────────────────────── */
function DotPattern({ gap = 22, size = 1.4, className = '' }) {
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: `radial-gradient(var(--color-border) ${size}px, transparent ${size}px)`,
