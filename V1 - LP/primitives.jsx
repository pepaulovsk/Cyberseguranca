...
(function injectPrimitivesCSS() {
  ...
  style.textContent = `
    ...
    .btn-primary:hover {
      ...
      box-shadow: 0 8px 24px -8px rgba(0, 203, 201, 0.45);
    }
    ...
    .badge-primary {
      ...
      background: rgba(0, 203, 201, 0.08);
      border-color: rgba(0, 203, 201, 0.28);
    }
    .badge-accent {
    ...
    .card-light:hover {
      border-color: rgba(0, 203, 201, 0.4);
      box-shadow: 0 12px 40px -16px rgba(10, 22, 40, 0.10);
    }
    .card-deep {
